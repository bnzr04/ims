                                ...
                                <table class="table">
                                    <thead class="bg-success text-white" style="position: sticky;top:0;">
                                        <tr>
                                            ...
                                            <th scope="col" class="border">Accepter</th>
...
<script>
            ...
            if (trans.status === 200) {
                ...
                if (data.length > 0) {
                    ...
                    data.forEach(function(row) {
                        var requestUrl = window.APP_URL + "/manager/view-request/" + row.id;
    ...
    var url = "{{ route('manager.filter-all-transaction') }}";
    var title = "Today transaction";
    index();

    thisDayBtn.addEventListener('click', function() {
        url = "{{ route('manager.filter-all-transaction') }}?this-day=1";
    ...
    thisWeekBtn.addEventListener('click', function() {
        url = "{{ route('manager.filter-all-transaction') }}?this-week=1";
    ...
    thisMonthBtn.addEventListener('click', function() {
        url = "{{ route('manager.filter-all-transaction') }}?this-month=1";
    ...
    filterForm.addEventListener('submit', function(event) {
        ...
        url = `{{ route('manager.filter-all-transaction') }}?filter=1&from=${dateFrom}&to=${dateTo}`;
    ...
    requestCodeSearchForm.addEventListener('submit', function(event) {
        ...
        url = `{{ route('manager.search-transaction') }}?req-code=${requestCodeInputSearch.value}`;
