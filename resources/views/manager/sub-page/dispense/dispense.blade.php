            ...
            if (xhr.status === 200) {
                ...
                if (data.length > 0) {
                    data.forEach(function(row) {
                        ...
                        dispense_table_head.innerHTML =
                            "<th scope='col' class='border'>Item ID</th><th scope='col' class='border'>Name</th><th scope='col' class='border'>Description</th><th scope='col' class='border'>Category</th><th scope='col' class='border'>Unit</th><th scope='col' class='border'>Current Stock</th><th scope='col' class='border'>Acquired</th><th scope='col' class='border'>Total Dispense</th><th scope='col' class='border'>Action</th>";
                        dispense_table.innerHTML +=
