            ...
            if (xhr.status === 200) {
                ...
                if (data.length > 0) {
                    data.forEach(function(row) {
                        ...
                        var url = window.APP_URL + '/admin/view-dispense/' + row.item_id;
                    ...
                    viewButtons.forEach(function(button) {
                        button.addEventListener("click", function() {
                            ...
                            var fetchUrl = window.APP_URL + "/admin/fetch-record/" + itemId;
                ...
                if (data.length > 0) {
                    ...
                    viewButtons.forEach(function(button) {
                        button.addEventListener("click", function() {
                            ...
                            //to fetch the records
                            var fetchUrl = window.APP_URL + "/admin/fetch-record/" + itemId + "?today=1";
                ...
                if (data.length > 0) {
                    ...
                    viewButtons.forEach(function(button) {
                        button.addEventListener("click", function() {
                            ...
                            //to fetch the records
                            var fetchUrl = window.APP_URL + "/admin/fetch-record/" + itemId + "?yesterday=1";
                ...
                if (data.length > 0) {
                    ...
                    viewButtons.forEach(function(button) {
                        button.addEventListener("click", function() {
                            ...
                            //to fetch the records
                            var fetchUrl = window.APP_URL + "/admin/fetch-record/" + itemId + "?this-month=1";
                ...
                if (data.length > 0) {
                    ...
                    viewButtons.forEach(function(button) {
                        button.addEventListener("click", function() {
                            ...
                            //to fetch the records
                            var fetchUrl = window.APP_URL + "/admin/fetch-record/" + itemId + "?filter=1&from=" + fromDateInput + "&to=" + toDateInput;
